<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="WebNoarJob.LoginPage" %>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div>
                                    <p class="mb-0">
                                        אין לך חשבון? <a href="/SignupPage.aspx" class="text-black-50 fw-bold">הרשם</a>
                                    </p>
                                </div>
